...
if (empty($_FILES) === false) {
	...
	$water_img = $_SERVER['DOCUMENT_ROOT'].'/watermark1.png';//水印图片,默认填写空,请将图片上传至网站根目录的upfiles下,例: water.gif
...
* 1为顶端居左，2为顶端居中，3为顶端居右；4为中部居左，5为中部居中，6为中部居右；7为底端居左，8为底端居中，9为底端居右；
